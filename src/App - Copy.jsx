                    ...
                    <div className="mt-8 p-6 bg-blue-50 border-l-4 border-blue-500 text-blue-800 rounded-lg shadow-inner animate-fade-in">
                        ...
                        {selectedHistoricalAdvice && (
                            <p className="text-sm text-blue-700 mt-3">
                                Generated on: {selectedHistoricalAdvice.timestamp?.toDate ? selectedHistoricalAdvice.toDate().toLocaleDateString() : 'Unknown date'}
                            </p>
                        )}
                    </div>
                )}
    ...
    const handleAddComment = async (postId) => {
        ...
        try {
            await addDoc(commentsCollectionRef, {
                ...
                userName: userName,
                timestamp: serverTimestamp(),
                imageUrl: commentImage // Include image URL if available
            });
